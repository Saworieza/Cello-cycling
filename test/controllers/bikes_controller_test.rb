...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post bikes_url, params: { bike: { biketype: @bike.biketype, description: @bike.description } }
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { biketype: @bike.biketype, description: @bike.description } }
